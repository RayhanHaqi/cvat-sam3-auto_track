...
do
    ...
    if [ "$func_rel_path" = "pytorch/facebookresearch/sam3" ]; then
        ...
        for var in SAM3_PROMPT_MODE SAM3_TEXT_PROMPT SAM3_OUTPUT_POLICY SAM3_OUTPUT_PROB_THRESH SAM3_IR_REFINE SAM3_IR_STOP_ON_MISSING SAM3_ADAPTIVE_PADDING_FACTOR SAM3_ADAPTIVE_ROI_SCALE SAM3_ADAPTIVE_MIN_ROI_MARGIN_PX SAM3_ADAPTIVE_MIN_SIDE_PX SAM3_ADAPTIVE_MAX_GROWTH_RATIO SAM3_ADAPTIVE_MAX_SHRINK_RATIO; do
            if [ -n "${!var:-}" ]; then
